...
class EditProfileStates extends StatefulWidget {
  @override
  _EditProfileStatesState createState() => _EditProfileStatesState();
}

class _EditProfileStatesState extends State<EditProfileStates> {
      ...
      appBar: AppBar(
        ...
        actions: [
          PopupMenuButton(
            itemBuilder: (context) => [
              PopupMenuItem(
                child: Text("Create District Admin"),
                value: "create_admin",
              ),
              PopupMenuItem(
